...
export async function GET(request: NextRequest) {
  ...
  const rows = courses.map((course) => ({
    ...
    "يوم المحاضرة": course.lectureDay,
    "بداية المحاضرة": course.lectureStartTime,
    "نهاية المحاضرة": course.lectureEndTime,
    "قاعة المحاضرة": course.lectureRoom ?? "",
    "يوم التطبيق": course.sectionDay,
    "بداية التطبيق": course.sectionStartTime,
    "نهاية التطبيق": course.sectionEndTime,
    "قاعة التطبيق": course.sectionRoom ?? "",
